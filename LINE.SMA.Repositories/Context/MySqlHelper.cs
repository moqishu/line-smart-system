    ...
    public class MySqlHelper
    {
        ...
        public MySqlConnection Conn
        {
            get
            {
                ...
                {
                    _Conn.ConnectionString = Db.Database.Connection.ConnectionString;
                    _Conn.Open();
                }
                return _Conn;
            }
        ...
        public static MySqlParameter[] DicToSqlParameters(Dictionary<string, object> source)
        {
            var result = new List<MySqlParameter>();
            foreach (var key in source.Keys)
            {
                if (result.All(p => p.ParameterName != key.ToLower()))
                    result.Add(new MySqlParameter(key.ToLower(), source[key]));
            }
