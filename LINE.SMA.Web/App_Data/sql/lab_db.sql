...
CREATE TABLE `lab_class` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '班级ID',
...
CREATE TABLE `lab_course_student` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '课程选择学生id',
  `course_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '课程id',
  `course_name` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '课程名称',
  `student_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '学生id',
  `student_name` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '学生名称',
...
CREATE TABLE `lab_discuss_reply` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '讨论回复id',
...
CREATE TABLE `lab_example` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '习题id',
  `example_name` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '习题名称',
  `example_content` text COLLATE utf8_bin NOT NULL COMMENT '习题内容',
...
CREATE TABLE `lab_experiment` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '实验id',
...
CREATE TABLE `lab_group_student` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '学生分组id',
...
-- ----------------------------
INSERT INTO `lab_index_photo` VALUES ('1', '科研方向', 'b0af563d-d147-454c-910b-3f602de0f4ee.jpg', 'upload/manager/20170828/5809289f-d2a9-4286-b137-7ec7443160a7.jpg', 'http://123.56.200.102:8080/jxcginfo.jsp?id=5', '0', '1', '', '2017-02-16 18:29:27', '2017-08-28 14:55:07');
INSERT INTO `lab_index_photo` VALUES ('2', '学术交流', '3de3bce6-113b-4042-9c59-fa93341e37ba.jpg', 'upload/manager/20170828/48ca932d-4dc4-4f48-8a65-e6b35300a3c4.jpg', 'http://123.56.200.102:8080/jxcginfo.jsp?id=4', '0', '1', '', '2017-02-16 18:29:36', '2017-08-28 14:55:07');
INSERT INTO `lab_index_photo` VALUES ('3', '综合实验中心', '3660cdde-8c85-420d-af8f-d2e45b273a22.jpg', 'upload/manager/20170828/0b658c3c-11bd-410b-be96-6d33efbf8cad.jpg', 'http://123.56.200.102:8080/jxcginfo.jsp?id=8', '0', '1', '', '2017-02-16 18:29:41', '2017-08-28 14:55:07');
INSERT INTO `lab_index_photo` VALUES ('4', '轮播电源', '9a5913cb-6cfb-4af2-9570-428ceaf38631.jpg', 'upload/manager/20170828/023f4835-21e8-483a-83f7-0a467b3a2af2.jpg', 'http://www.baidu.com', '1', '1', '', '2017-02-16 18:56:45', '2017-08-28 14:56:09');
INSERT INTO `lab_index_photo` VALUES ('5', '轮播2', '6acc7c94-6618-482e-b6e6-3e4864bdecba.jpg', 'upload/manager/20170828/36b4885f-43ce-4d0c-9da0-b333ead51c81.jpg', 'http://www.163.com', '1', '1', '', '2017-02-16 18:56:45', '2017-08-28 14:56:09');
INSERT INTO `lab_index_photo` VALUES ('6', '轮播3', 'faed9558-b6e9-4218-b107-337711cfc75f.jpg', 'upload/manager/20170828/52e6f64c-3d1a-46ef-8153-53e3d44a5c2a.jpg', 'http://www.sohu.com', '1', '1', '', '2017-02-16 18:56:45', '2017-08-28 14:56:09');
...
INSERT INTO `lab_message` VALUES ('14', '关于召开ICSNCE 2016国际会议的通知', '为促进我国与国际社会在计算机科学、新型网络检测与控制领域的交流与合作，由新型网络与检测控制国家地方联合工程实验室、西安工业大学（Xi\'an Technological University）发起，得到美国密苏里西州立大学、新加坡国立大学、香港科技大学等国内外高校与法国Atlantic出版社的大力支持，将于2016年7月8-10日在陕西省西安市举办网络工程与计算机科学国际会议。会议录用文章将提交ISTP（现改名CPCI）检索，会议相关信息如下：\n\n  会议名称：计算机网络工程与计算机科学国际会议\n\n  英文名称（简称）：2016 International Conference of Network Engineering and Computer Science (ICSNCE2016) \n\n会议举办时间和地点：2016年7月8-10日，西安市南洋大酒店\n\n会议网站见西安工业大学计算机科学与工程学院网页\n\n会议联系方式： 029-86173290、icsnce @163.com  \n\n组委会地址： 陕西省西安市西安工业大学（工一楼519室）\n\n联系人：周老师\n\n \n\n2016年2月29日\n', '3', '1', '0', '1', 'admin', '2017-04-19 18:22:45', '2017-04-19 18:22:45');
INSERT INTO `lab_message` VALUES ('15', 'XXX', 'XXXXXXXXXXXXXXXXX', '3', '2', '0', '1', 'admin', '2017-08-18 10:33:27', '2017-08-18 10:33:27');
...
CREATE TABLE `lab_module` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '模块编号',
...
CREATE TABLE `lab_module_role` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '模块角色id',
...
CREATE TABLE `lab_room_station` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '课位ID',
  `room_id` bigint(20) unsigned NOT NULL COMMENT '教室ID',
